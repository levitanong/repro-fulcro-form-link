...
`src/main/repro_fulcro_form_link/client.cljs` contains the code to start and refresh
...
application `repro-fulcro-form-link.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/repro_fulcro_form_link.jar
```
